...
public class CreditosController {
	...
	public String abrirRegistrarCreditos(Model model,
		...
		Page<Credito> articlePage = creditoService.findByNCodigocn(u.getConcesionario().getId(), pageable);				
	...
	public String buscar(Model model,
		...
		if(u.getPerfil().getId()==1) {
			...
			articlePage = creditoService.findCreditosRegistrados(u.getConcesionario().getId(), pageable);
			//articlePage = creditoService.findCreditosRegistrados(codigoCN, pageable);	
		}
