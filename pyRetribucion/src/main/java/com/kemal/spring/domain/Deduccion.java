...
@NoArgsConstructor
@Entity
@Table(name = "SRET_DEDUCCION")
public class Deduccion {
	 @Id
	    @Column(name = "NCODIGO", unique = true, nullable = false)
	    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator = "id_SequenceDEDUCCION")
	    @SequenceGenerator(name = "id_SequenceDEDUCCION", sequenceName = "SQ_RET_DEDUCCION", allocationSize= 1)
	    private Integer id;
