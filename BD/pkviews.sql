...
--------------------------------------------------------
DROP TABLE "ROL_APP" cascade constraints;
DROP TABLE "SRET_APORTE" cascade constraints;
DROP TABLE "SRET_APORTEDEDUCCION" cascade constraints;
DROP TABLE "SRET_APORTEDESCUENTO" cascade constraints;
DROP TABLE "SRET_APORTELIBERACION" cascade constraints;
DROP TABLE "SRET_APORTEPORCENTAJE" cascade constraints;
DROP TABLE "SRET_APORTETIPO" cascade constraints;
DROP TABLE "SRET_ARCHIVO" cascade constraints;
DROP TABLE "SRET_BANCO" cascade constraints;
DROP TABLE "SRET_BASECALCULO" cascade constraints;
DROP TABLE "SRET_BUENCONTRIBUYENTE" cascade constraints;
DROP TABLE "SRET_CONCEPTO" cascade constraints;
DROP TABLE "SRET_CONTRATO" cascade constraints;
DROP TABLE "SRET_CONTRIBUYENTE" cascade constraints;
DROP TABLE "SRET_CREDITO" cascade constraints;
DROP TABLE "SRET_DEDUCCION" cascade constraints;
DROP TABLE "SRET_DESCUENTO" cascade constraints;
DROP TABLE "SRET_ESTADO" cascade constraints;
DROP TABLE "SRET_LIBERACIONPAGO" cascade constraints;
DROP TABLE "SRET_LIQUIDACION" cascade constraints;
DROP TABLE "SRET_MODULO" cascade constraints;
DROP TABLE "SRET_MONEDA" cascade constraints;
DROP TABLE "SRET_PAGO" cascade constraints;
DROP TABLE "SRET_PAGOSINAPORTE" cascade constraints;
DROP TABLE "SRET_PARAMETRO" cascade constraints;
DROP TABLE "SRET_PERFIL" cascade constraints;
DROP TABLE "SRET_REPRESENTANTE" cascade constraints;
DROP TABLE "SRET_TIPOPERIODICIDAD" cascade constraints;
DROP TABLE "SRET_TIPOPERIODICIDADDET" cascade constraints;
DROP TABLE "SRET_TIPORETRIBUCION" cascade constraints;
DROP TABLE "SRET_TIPOVENCIMIENTO" cascade constraints;
DROP TABLE "SRET_TIPO_DOCUMENTO" cascade constraints;
DROP TABLE "USERS_ROLES" cascade constraints;
DROP TABLE "USER_APP" cascade constraints;
DROP SEQUENCE "SQ_RET_APORTE";
DROP SEQUENCE "SQ_RET_APORTEDEDUCCION";
DROP SEQUENCE "SQ_RET_APORTEDESCUENTO";
DROP SEQUENCE "SQ_RET_APORTELIBERACION";
DROP SEQUENCE "SQ_RET_APORTEPORCENTAJE";
DROP SEQUENCE "SQ_RET_ARCHIVO";
DROP SEQUENCE "SQ_RET_BANCO";
DROP SEQUENCE "SQ_RET_BASECALCULO";
DROP SEQUENCE "SQ_RET_BUENCONTRIBUYENTE";
DROP SEQUENCE "SQ_RET_CONCEPTO";
DROP SEQUENCE "SQ_RET_CONTRATO";
DROP SEQUENCE "SQ_RET_CONTRIBUYENTE";
DROP SEQUENCE "SQ_RET_CREDITO";
DROP SEQUENCE "SQ_RET_DEDUCCION";
DROP SEQUENCE "SQ_RET_LIBERACIONPAGO";
DROP SEQUENCE "SQ_RET_LIQUIDACION";
DROP SEQUENCE "SQ_RET_MODULO";
DROP SEQUENCE "SQ_RET_MONEDA";
DROP SEQUENCE "SQ_RET_OTRODESCUENTO";
DROP SEQUENCE "SQ_RET_PAGO";
DROP SEQUENCE "SQ_RET_PAGOSINAPORTE";
DROP SEQUENCE "SQ_RET_PERFIL";
DROP SEQUENCE "SQ_RET_REPRESENTANTE";
DROP SEQUENCE "SQ_RET_ROLE";
DROP SEQUENCE "SQ_RET_TIPODOCUMENTO";
DROP SEQUENCE "SQ_RET_TIPOPERIODICIDAD";
DROP SEQUENCE "SQ_RET_TIPOPERIODICIDADDET";
DROP SEQUENCE "SQ_RET_TIPORETRIBUCION";
DROP SEQUENCE "SQ_RET_TIPOVENCIMIENTO";
DROP SEQUENCE "SQ_RET_USER";
DROP VIEW "VW_CREDITOREGISTRADO";
DROP VIEW "VW_DECLARACION";
DROP VIEW "VW_NUEVOCREDITO";
DROP PACKAGE "PK_RET_APORTE";
DROP PACKAGE "PK_RET_LIQUIDACION";
DROP PACKAGE "PK_RET_MENU";
DROP PACKAGE "PK_RET_PAGOSA";
DROP PACKAGE "PK_RET_SALDOS";
DROP PACKAGE "PK_USER";
DROP PACKAGE "PK_USUARIO";
DROP PACKAGE "PK_UTIL_DATE";
DROP PACKAGE BODY "PK_RET_APORTE";
DROP PACKAGE BODY "PK_RET_LIQUIDACION";
DROP PACKAGE BODY "PK_RET_MENU";
DROP PACKAGE BODY "PK_RET_PAGOSA";
DROP PACKAGE BODY "PK_RET_SALDOS";
DROP PACKAGE BODY "PK_USER";
DROP PACKAGE BODY "PK_USUARIO";
DROP PACKAGE BODY "PK_UTIL_DATE";
--------------------------------------------------------
--  DDL for Sequence SQ_RET_APORTE
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_APORTE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_APORTEDEDUCCION
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_APORTEDEDUCCION"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_APORTEDESCUENTO
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_APORTEDESCUENTO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_APORTELIBERACION
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_APORTELIBERACION"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_APORTEPORCENTAJE
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_APORTEPORCENTAJE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_ARCHIVO
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_ARCHIVO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_BANCO
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_BANCO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_BASECALCULO
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_BASECALCULO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_BUENCONTRIBUYENTE
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_BUENCONTRIBUYENTE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_CONCEPTO
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_CONCEPTO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_CONTRATO
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_CONTRATO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_CONTRIBUYENTE
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_CONTRIBUYENTE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_CREDITO
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_CREDITO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_DEDUCCION
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_DEDUCCION"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_LIBERACIONPAGO
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_LIBERACIONPAGO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_LIQUIDACION
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_LIQUIDACION"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_MODULO
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_MODULO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_MONEDA
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_MONEDA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_OTRODESCUENTO
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_OTRODESCUENTO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_PAGO
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_PAGO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_PAGOSINAPORTE
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_PAGOSINAPORTE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_PERFIL
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_PERFIL"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_REPRESENTANTE
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_REPRESENTANTE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_ROLE
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_ROLE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_TIPODOCUMENTO
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_TIPODOCUMENTO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_TIPOPERIODICIDAD
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_TIPOPERIODICIDAD"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_TIPOPERIODICIDADDET
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_TIPOPERIODICIDADDET"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_TIPORETRIBUCION
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_TIPORETRIBUCION"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_TIPOVENCIMIENTO
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_TIPOVENCIMIENTO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SQ_RET_USER
--------------------------------------------------------

   CREATE SEQUENCE  "SQ_RET_USER"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SRET_APORTEDEDUCCION" 
   (	"NCODIGO" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SRET_APORTEDESCUENTO" 
   (	"NCODIGO" NUMBER(10,0), 
	"DFECHAMODIFICA" TIMESTAMP (6), 
	"DFECHAREGISTRO" TIMESTAMP (6), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SRET_APORTELIBERACION" 
   (	"NCODIGO" NUMBER(10,0), 
	"DFECHAMODIFICA" TIMESTAMP (6), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SRET_APORTEPORCENTAJE" 
   (	"NCODIGO" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SRET_BUENCONTRIBUYENTE" 
   (	"NCODIGO" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SRET_CONTRIBUYENTE" 
   (	"NCODIGO" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SRET_LIBERACIONPAGO" 
   (	"NCODIGO" NUMBER(10,0), 
	"DFECHAMODIFICA" TIMESTAMP (6), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SRET_PAGOSINAPORTE" 
   (	"NCODIGO" NUMBER(10,0), 
	"DFECPAGOVOUCHER" TIMESTAMP (6), 
	"DFECHAREGISTRO" TIMESTAMP (6), 
	"NCODIGOCNS" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SRET_REPRESENTANTE" 
   (	"NCODIGO" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SRET_TIPOPERIODICIDAD" 
   (	"NCODIGO" NUMBER(10,0), 
	"ORDERBY" NUMBER(10,0), 
	"SDESCRIPCION" VARCHAR2(255 CHAR), 
	"SESTADO" VARCHAR2(255 CHAR)
...
--------------------------------------------------------
  ...
  CREATE TABLE "SRET_TIPOPERIODICIDADDET" 
   (	"NCODIGO" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SRET_TIPORETRIBUCION" 
   (	"NCODIGO" NUMBER(10,0), 
	"SDESCRIPCION" VARCHAR2(255 CHAR), 
	"SESTADO" VARCHAR2(255 CHAR)
   )
...
--------------------------------------------------------
  ...
  CREATE TABLE "SRET_TIPOVENCIMIENTO" 
   (	"NCODIGO" NUMBER(10,0), 
	"SDESCRIPCION" VARCHAR2(255 CHAR), 
	"SESTADO" VARCHAR2(255 CHAR)
   )
...
--------------------------------------------------------
  ...
  CREATE TABLE "SRET_TIPO_DOCUMENTO" 
   (	"NCODIGO" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE  VIEW "VW_DECLARACION" ("NCODIGO", "NCODIGOCN", "S_TIPO_PERIODICIDAD", "S_TIPO_RETRIBUCION", "S_ANIO_PERIODO", "S_MES_PERIODO", "FECHA_VEN_PAGO", "FECHA_VEN_PRES", "S_ESTADO", "NCODIGOAT", "NRET_RESULTANTE") AS 
  SELECT NCODIGO,
      NCODIGOCN,
      S_TIPO_PERIODICIDAD,
      S_TIPO_RETRIBUCION,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE  VIEW "VW_NUEVOCREDITO" ("CODIGO", "NCODIGO", "S_TIPO_PERIODICIDAD", "S_TIPO_RETRIBUCION", "STIPO_PERIODO_NOM", "STIPO_RETRIBU_NOM", "S_ANIO_PERIODO", "S_MES_PERIODO", "NRET_RESULTANTE", "NCODIGOCN") AS 
  SELECT  
 rownum codigo,
 A.NCODIGO,
...
REM INSERTING into ROL_APP
SET DEFINE OFF;
Insert into ROL_APP (ID,NAME) values (1,'ROLE_ADMIN');
Insert into ROL_APP (ID,NAME) values (2,'ROLE_USER');
REM INSERTING into SRET_APORTE
SET DEFINE OFF;
...
REM INSERTING into SRET_APORTEDEDUCCION
SET DEFINE OFF;
REM INSERTING into SRET_APORTEDESCUENTO
SET DEFINE OFF;
REM INSERTING into SRET_APORTELIBERACION
SET DEFINE OFF;
REM INSERTING into SRET_APORTEPORCENTAJE
SET DEFINE OFF;
REM INSERTING into SRET_APORTETIPO
SET DEFINE OFF;
Insert into SRET_APORTETIPO (NCODIGO,S_DESCRIPCION,S_ESTADO) values ('I','INGRESADO','1');
Insert into SRET_APORTETIPO (NCODIGO,S_DESCRIPCION,S_ESTADO) values ('P','PRESENTADO','1');
Insert into SRET_APORTETIPO (NCODIGO,S_DESCRIPCION,S_ESTADO) values ('R','RECHAZADADO','1');
Insert into SRET_APORTETIPO (NCODIGO,S_DESCRIPCION,S_ESTADO) values ('E','ELIMINADO','1');
REM INSERTING into SRET_ARCHIVO
SET DEFINE OFF;
REM INSERTING into SRET_BANCO
SET DEFINE OFF;
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (1,'BANCO DE COMERCIO','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (2,'BANCO INTERAMERICANO DE FINANZAS (BANBIF)','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (3,'BANCO PICHINCHA','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (4,'BBVA','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (5,'CITIBANK PERÚ','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (6,'INTERBANK','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (7,'MIBANCO','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (8,'BANCO GNB PERÚ','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (9,'BANCO FALABELLA','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (10,'BANCO RIPLEY','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (11,'BANCO SANTANDER PERÚ','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (12,'BANCO AZTECA','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (13,'CRAC CAT PERÚ','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (14,'ICBC PERU BANK','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (15,'AGROBANCO','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (16,'BANCO DE LA NACIÓN','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (17,'COFIDE','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (18,'FONDO MIVIVIENDA','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (19,'BANCO DE CRÉDITO DEL PERÚ','1');
Insert into SRET_BANCO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (20,'SCOTIABANK','1');
REM INSERTING into SRET_BASECALCULO
SET DEFINE OFF;
Insert into SRET_BASECALCULO (NCODIGO,NCODIGO_AP,NIMPORTE,S_DESCRIPCION,S_ESTADO,NCODIGO_CONCEPTO) values (1,1,7000,'x','1',6);
REM INSERTING into SRET_BUENCONTRIBUYENTE
SET DEFINE OFF;
REM INSERTING into SRET_CONCEPTO
SET DEFINE OFF;
Insert into SRET_CONCEPTO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO,NCODIGO_MODULO) values (1,to_timestamp('29-JAN-20 08.55.13.414000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'ORIGINAL','1',2);
Insert into SRET_CONCEPTO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO,NCODIGO_MODULO) values (2,to_timestamp('29-JAN-20 08.55.13.463000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'SUSTITUTORIA','1',2);
Insert into SRET_CONCEPTO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO,NCODIGO_MODULO) values (3,to_timestamp('29-JAN-20 08.55.13.511000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'RECTIFICATORIA','1',2);
Insert into SRET_CONCEPTO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO,NCODIGO_MODULO) values (4,to_timestamp('29-JAN-20 08.55.13.560000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'CRONOGRAMA DE PAGO','1',5);
Insert into SRET_CONCEPTO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO,NCODIGO_MODULO) values (5,to_timestamp('29-JAN-20 08.55.13.604000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'CRONOGRAMA DE PRESENTACIÓN','1',5);
Insert into SRET_CONCEPTO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO,NCODIGO_MODULO) values (6,to_timestamp('29-JAN-20 08.55.13.647000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'INGRESO','1',3);
Insert into SRET_CONCEPTO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO,NCODIGO_MODULO) values (7,to_timestamp('29-JAN-20 08.55.13.691000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'INGRESOS NO REGULADOS','1',3);
Insert into SRET_CONCEPTO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO,NCODIGO_MODULO) values (8,to_timestamp('29-JAN-20 08.55.13.740000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'INGRESOS NO REGULADOS BASE','1',3);
Insert into SRET_CONCEPTO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO,NCODIGO_MODULO) values (9,to_timestamp('29-JAN-20 08.55.13.773000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'DEDUCCIONES','1',6);
Insert into SRET_CONCEPTO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO,NCODIGO_MODULO) values (10,to_timestamp('29-JAN-20 08.55.13.807000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'PAGOS PREVIOS','1',6);
Insert into SRET_CONCEPTO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO,NCODIGO_MODULO) values (11,to_timestamp('29-JAN-20 08.55.13.842000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'CREDITOS','1',6);
Insert into SRET_CONCEPTO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO,NCODIGO_MODULO) values (12,to_timestamp('29-JAN-20 08.55.13.903000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'LIBERACION DE PAGO','1',6);
Insert into SRET_CONCEPTO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO,NCODIGO_MODULO) values (13,to_timestamp('29-JAN-20 08.55.13.945000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'OTROS DESCUENTOS','1',6);
REM INSERTING into SRET_CONTRATO
SET DEFINE OFF;
REM INSERTING into SRET_CONTRIBUYENTE
SET DEFINE OFF;
Insert into SRET_CONTRIBUYENTE (NCODIGO,S_CORREO,S_TELEFONO,SESTADO,SNOMBRE,SRUC) values (1,null,null,'1','LIMA AIRPORT PARTNERS S.R.L.','20501577252');
Insert into SRET_CONTRIBUYENTE (NCODIGO,S_CORREO,S_TELEFONO,SESTADO,SNOMBRE,SRUC) values (2,null,null,'1','AEROPUERTOS DEL PERÚ S.A.','20514513172');
Insert into SRET_CONTRIBUYENTE (NCODIGO,S_CORREO,S_TELEFONO,SESTADO,SNOMBRE,SRUC) values (3,null,null,'1','FERROCARRILES TRANSANDINO S.A','20432747833');
Insert into SRET_CONTRIBUYENTE (NCODIGO,S_CORREO,S_TELEFONO,SESTADO,SNOMBRE,SRUC) values (4,null,null,'1','FERROVIAS CENTRAL ANDINA S.A.','20432347142');
Insert into SRET_CONTRIBUYENTE (NCODIGO,S_CORREO,S_TELEFONO,SESTADO,SNOMBRE,SRUC) values (5,null,null,'1','CONCESIONARIA VIAL DEL PERU S.A. ','20511465061');
Insert into SRET_CONTRIBUYENTE (NCODIGO,S_CORREO,S_TELEFONO,SESTADO,SNOMBRE,SRUC) values (6,null,null,'1','NORVIAL S.A.','20505377142');
Insert into SRET_CONTRIBUYENTE (NCODIGO,S_CORREO,S_TELEFONO,SESTADO,SNOMBRE,SRUC) values (7,null,null,'1','TERMINAL INTERNACIONAL DEL SUR S.A.','20428500475');
Insert into SRET_CONTRIBUYENTE (NCODIGO,S_CORREO,S_TELEFONO,SESTADO,SNOMBRE,SRUC) values (8,null,null,'1','APM TERMINALS CALLAO S.A.','20543083888');
Insert into SRET_CONTRIBUYENTE (NCODIGO,S_CORREO,S_TELEFONO,SESTADO,SNOMBRE,SRUC) values (9,null,null,'1','DP WORLD CALLAO S.R.L.','20513462388');
Insert into SRET_CONTRIBUYENTE (NCODIGO,S_CORREO,S_TELEFONO,SESTADO,SNOMBRE,SRUC) values (10,null,null,'1','TERMINALES PORTUARIOS EUROANDINOS PAITA S.A. - TPE PAITA S.A.','20522473571');
Insert into SRET_CONTRIBUYENTE (NCODIGO,S_CORREO,S_TELEFONO,SESTADO,SNOMBRE,SRUC) values (11,null,null,'1','TERMINAL PORTUARIO PARACAS S.A.','20562916360');
Insert into SRET_CONTRIBUYENTE (NCODIGO,S_CORREO,S_TELEFONO,SESTADO,SNOMBRE,SRUC) values (12,null,null,'1','TRANSPORTADORA CALLAO S.A.','20537577232');
Insert into SRET_CONTRIBUYENTE (NCODIGO,S_CORREO,S_TELEFONO,SESTADO,SNOMBRE,SRUC) values (13,null,null,'1','SALAVERRY TERMINAL INTERNACIONAL S.A.','20603487321');
REM INSERTING into SRET_CREDITO
SET DEFINE OFF;
Insert into SRET_CREDITO (NCODIGO,SANIOPERIODO_DESTINO,SANIOPERIODO_ORIGEN,DFECHAAPLICADO,DFECHAMODIFICA,DFECHAREGISTRO,SMESPERIODO_DESTINO,SMESPERIODO_ORIGEN,NCODIGOCN,NCODIGO_APORTE,NIMPORTE,SESTADO,SUSUMODIFICA,SUSUREGISTRA,NTIPO_PERIODICIDAD_DESTINO,NTIPO_PERIODICIDAD_ORIGEN,NTIPO_RETRIBUCION_DESTINO,NTIPO_RETRIBUCION_ORIGEN,NCODIGO_ESTADO) values (1,'2020','2016',null,null,to_date('30-JAN-20','DD-MON-RR'),'10','01',1,1,-899999,'1',null,'limaai','1','2','1','1',1);
REM INSERTING into SRET_DEDUCCION
SET DEFINE OFF;
REM INSERTING into SRET_DESCUENTO
SET DEFINE OFF;
REM INSERTING into SRET_ESTADO
SET DEFINE OFF;
Insert into SRET_ESTADO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (0,'ELIMINADO','1');
Insert into SRET_ESTADO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (1,'REGISTRADO','1');
Insert into SRET_ESTADO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (2,'APLICADO','1');
Insert into SRET_ESTADO (NCODIGO,S_DESCRIPCION,S_ESTADO) values (3,'ANULADO','1');
REM INSERTING into SRET_LIBERACIONPAGO
SET DEFINE OFF;
REM INSERTING into SRET_LIQUIDACION
SET DEFINE OFF;
Insert into SRET_LIQUIDACION (NCODIGO,DFECHAMODIFICA,DFECHAREGISTRO,NANIO,NIDTIPODOCUMENTO,NORDEN,NPERIODO,SDOCUMENTO,SESTADO,SUSUMODIFICA,SUSUREGISTRA) values (3,to_timestamp('29-JAN-20 09.12.38.351000000 PM','DD-MON-RR HH.MI.SSXFF AM'),to_timestamp('29-JAN-20 09.12.38.351000000 PM','DD-MON-RR HH.MI.SSXFF AM'),2019,2,0,1,'G1580350356835J.pdf','1',null,null);
Insert into SRET_LIQUIDACION (NCODIGO,DFECHAMODIFICA,DFECHAREGISTRO,NANIO,NIDTIPODOCUMENTO,NORDEN,NPERIODO,SDOCUMENTO,SESTADO,SUSUMODIFICA,SUSUREGISTRA) values (6,to_timestamp('29-JAN-20 09.32.18.277000000 PM','DD-MON-RR HH.MI.SSXFF AM'),to_timestamp('29-JAN-20 09.32.18.277000000 PM','DD-MON-RR HH.MI.SSXFF AM'),2019,1,0,1,'H1580351534953K.pdf','1',null,null);
Insert into SRET_LIQUIDACION (NCODIGO,DFECHAMODIFICA,DFECHAREGISTRO,NANIO,NIDTIPODOCUMENTO,NORDEN,NPERIODO,SDOCUMENTO,SESTADO,SUSUMODIFICA,SUSUREGISTRA) values (8,to_timestamp('29-JAN-20 09.36.34.533000000 PM','DD-MON-RR HH.MI.SSXFF AM'),to_timestamp('29-JAN-20 09.36.34.533000000 PM','DD-MON-RR HH.MI.SSXFF AM'),2019,1,0,1,'J1580351791781L.pdf','1',null,null);
Insert into SRET_LIQUIDACION (NCODIGO,DFECHAMODIFICA,DFECHAREGISTRO,NANIO,NIDTIPODOCUMENTO,NORDEN,NPERIODO,SDOCUMENTO,SESTADO,SUSUMODIFICA,SUSUREGISTRA) values (4,to_timestamp('29-JAN-20 09.12.38.351000000 PM','DD-MON-RR HH.MI.SSXFF AM'),to_timestamp('29-JAN-20 09.12.38.351000000 PM','DD-MON-RR HH.MI.SSXFF AM'),2019,1,0,1,'E1580350355901O.pdf','1',null,null);
REM INSERTING into SRET_MODULO
SET DEFINE OFF;
Insert into SRET_MODULO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO) values (1,to_timestamp('29-JAN-20 08.55.13.101000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'PAGO','1');
Insert into SRET_MODULO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO) values (2,to_timestamp('29-JAN-20 08.55.13.153000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'APORTE TIPO DJ','1');
Insert into SRET_MODULO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO) values (3,to_timestamp('29-JAN-20 08.55.13.211000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'APORTE BASEIMPONIBLE','1');
Insert into SRET_MODULO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO) values (4,to_timestamp('29-JAN-20 08.55.13.256000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'CONTRATO','1');
Insert into SRET_MODULO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO) values (5,to_timestamp('29-JAN-20 08.55.13.317000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'CRONOGRAMA','1');
Insert into SRET_MODULO (NCODIGO,DFECHAREGISTRO,SDESCRIPCION,SESTADO) values (6,to_timestamp('29-JAN-20 08.55.13.370000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'APORTE OTROS CONCEPTOS','1');
REM INSERTING into SRET_MONEDA
SET DEFINE OFF;
Insert into SRET_MONEDA (NCODIGO,S_DESCRIPCION,S_ESTADO,S_SIMBOLO) values (1,'SOL','1','S/');
Insert into SRET_MONEDA (NCODIGO,S_DESCRIPCION,S_ESTADO,S_SIMBOLO) values (2,'DÓLARES AMERICANOS','1','$');
REM INSERTING into SRET_PAGO
SET DEFINE OFF;
REM INSERTING into SRET_PAGOSINAPORTE
SET DEFINE OFF;
Insert into SRET_PAGOSINAPORTE (NCODIGO,DFECPAGOVOUCHER,DFECHAREGISTRO,NCODIGOCNS,NIMPORTE,NROOPERACION,OBSERVACION,ANIORETRIBUCION,SDOCUMENTO,SESTADO,MESRETRIBUCION,NCODIGOBANCO,NCODIGOMONEDA,S_TIPO_PERIODICIDAD,S_TIPO_RETRIBUCION) values (1,to_timestamp('02-JAN-20 12.00.00.000000000 AM','DD-MON-RR HH.MI.SSXFF AM'),to_timestamp('30-JAN-20 10.11.27.286000000 AM','DD-MON-RR HH.MI.SSXFF AM'),1,900000,'hhh','hhhh','2020','J1580397086018G.pdf','1','01',1,null,2,1);
REM INSERTING into SRET_PARAMETRO
SET DEFINE OFF;
REM INSERTING into SRET_PERFIL
SET DEFINE OFF;
Insert into SRET_PERFIL (NCODIGO,ESTADO,S_DESCRIPCION) values (1,'1','CONCESIONARIO');
Insert into SRET_PERFIL (NCODIGO,ESTADO,S_DESCRIPCION) values (2,'1','SUPERVISOR');
Insert into SRET_PERFIL (NCODIGO,ESTADO,S_DESCRIPCION) values (3,'1','TESORERIA');
Insert into SRET_PERFIL (NCODIGO,ESTADO,S_DESCRIPCION) values (4,'1','INVITADO');
REM INSERTING into SRET_REPRESENTANTE
SET DEFINE OFF;
REM INSERTING into SRET_TIPOPERIODICIDAD
SET DEFINE OFF;
Insert into SRET_TIPOPERIODICIDAD (NCODIGO,ORDERBY,SDESCRIPCION,SESTADO) values (1,1,'MENSUAL','1');
Insert into SRET_TIPOPERIODICIDAD (NCODIGO,ORDERBY,SDESCRIPCION,SESTADO) values (2,2,'TRIMESTRAL','1');
Insert into SRET_TIPOPERIODICIDAD (NCODIGO,ORDERBY,SDESCRIPCION,SESTADO) values (3,3,'SEMESTRAL','1');
Insert into SRET_TIPOPERIODICIDAD (NCODIGO,ORDERBY,SDESCRIPCION,SESTADO) values (4,4,'ANUAL','1');
REM INSERTING into SRET_TIPOPERIODICIDADDET
SET DEFINE OFF;
REM INSERTING into SRET_TIPORETRIBUCION
SET DEFINE OFF;
Insert into SRET_TIPORETRIBUCION (NCODIGO,SDESCRIPCION,SESTADO) values (1,'RETRIBUCION','1');
Insert into SRET_TIPORETRIBUCION (NCODIGO,SDESCRIPCION,SESTADO) values (2,'PRINCIPAL','1');
Insert into SRET_TIPORETRIBUCION (NCODIGO,SDESCRIPCION,SESTADO) values (3,'ESPECIAL','1');
Insert into SRET_TIPORETRIBUCION (NCODIGO,SDESCRIPCION,SESTADO) values (4,'FONCEPRI','1');
REM INSERTING into SRET_TIPOVENCIMIENTO
SET DEFINE OFF;
Insert into SRET_TIPOVENCIMIENTO (NCODIGO,SDESCRIPCION,SESTADO) values (1,'SEGÚN CONTRATO','1');
Insert into SRET_TIPOVENCIMIENTO (NCODIGO,SDESCRIPCION,SESTADO) values (2,'SEGÚN SUNAT','1');
REM INSERTING into SRET_TIPO_DOCUMENTO
SET DEFINE OFF;
...
REM INSERTING into USER_APP
SET DEFINE OFF;
Insert into USER_APP (ID,EMAIL,ENABLED,ESTADO_CORREO,NAME,PASSWORD,S_TELEFONO,S_TIPO_USUARIO,SURNAME,USERNAME,NCODIGOCNT,NCODIGO_PERFIL) values (1,'admin@gmail.com',1,null,'Admin','$2a$10$EmD8izR6g0tSEBQHVAPRPusBrZpIre0CJ/spWSGroVwT3cKfkVR9q',null,'E','Admin','limaai',1,2);
Insert into USER_APP (ID,EMAIL,ENABLED,ESTADO_CORREO,NAME,PASSWORD,S_TELEFONO,S_TIPO_USUARIO,SURNAME,USERNAME,NCODIGOCNT,NCODIGO_PERFIL) values (2,'adp@gmail.com',1,null,'User','$2a$10$gRhEXhxHLs8deKRg9uKt..h9Q/JDJr/G33S/5iNbfk.BaiEqTsFma',null,'E','User','adp',2,2);
Insert into USER_APP (ID,EMAIL,ENABLED,ESTADO_CORREO,NAME,PASSWORD,S_TELEFONO,S_TIPO_USUARIO,SURNAME,USERNAME,NCODIGOCNT,NCODIGO_PERFIL) values (3,'tisur@gmail.com',1,null,'apmter','$2a$10$KfQEvOJqvFwQzHMpsB5Rf.NEdIcuhjS36AvdRvtX8HubcWFkEQJGW',null,'E','tisur','tisur',7,2);
REM INSERTING into VW_CREDITOREGISTRADO
SET DEFINE OFF;
Insert into VW_CREDITOREGISTRADO (NCODIGO,SPERIODICIDAD_ORIGEN,SRETRIBUCION_ORIGEN,SANIOPERIODO_ORIGEN,SMESPERIODO_ORIGEN,SPERIODICIDAD_DESTINO,SRETRIBUCION_DESTINO,SANIOPERIODO_DESTINO,SMESPERIODO_DESTINO,DFECHAAPLICADO,DFECHAMODIFICA,DFECHAREGISTRO,NIMPORTE,NCODIGOCN,NCODIGO_APORTE,SUSUMODIFICA,SUSUREGISTRA,NCODIGO_ESTADO,ESTADO) values (1,'TRIMESTRAL','RETRIBUCION','2016','01','MENSUAL','RETRIBUCION','2020','10',null,null,to_date('30-JAN-20','DD-MON-RR'),-899999,1,1,null,'limaai',1,'REGISTRADO');
REM INSERTING into VW_DECLARACION
SET DEFINE OFF;
Insert into VW_DECLARACION (NCODIGO,NCODIGOCN,S_TIPO_PERIODICIDAD,S_TIPO_RETRIBUCION,S_ANIO_PERIODO,S_MES_PERIODO,FECHA_VEN_PAGO,FECHA_VEN_PRES,S_ESTADO,NCODIGOAT,NRET_RESULTANTE) values (1,1,2,1,'2020','01',null,null,'1','P',-899999);
REM INSERTING into VW_NUEVOCREDITO
SET DEFINE OFF;
--------------------------------------------------------
--  DDL for Index SYS_C00149766
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYS_C00149766" ON "ROL_APP" ("ID") 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149768" ON "SRET_APORTE" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149770" ON "SRET_APORTEDEDUCCION" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149772" ON "SRET_APORTEDESCUENTO" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149774" ON "SRET_APORTELIBERACION" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149776" ON "SRET_APORTEPORCENTAJE" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149778" ON "SRET_APORTETIPO" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149780" ON "SRET_ARCHIVO" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149782" ON "SRET_BANCO" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149784" ON "SRET_BASECALCULO" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149786" ON "SRET_BUENCONTRIBUYENTE" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149788" ON "SRET_CONCEPTO" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149790" ON "SRET_CONTRATO" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149792" ON "SRET_CONTRIBUYENTE" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149794" ON "SRET_CREDITO" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149796" ON "SRET_DEDUCCION" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149798" ON "SRET_DESCUENTO" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149800" ON "SRET_ESTADO" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149802" ON "SRET_LIBERACIONPAGO" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149804" ON "SRET_LIQUIDACION" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149806" ON "SRET_MODULO" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149808" ON "SRET_MONEDA" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149810" ON "SRET_PAGO" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149812" ON "SRET_PAGOSINAPORTE" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149814" ON "SRET_PARAMETRO" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149816" ON "SRET_PERFIL" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149819" ON "SRET_REPRESENTANTE" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149821" ON "SRET_TIPO_DOCUMENTO" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149823" ON "SRET_TIPOPERIODICIDAD" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149828" ON "SRET_TIPOPERIODICIDADDET" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149830" ON "SRET_TIPORETRIBUCION" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149833" ON "SRET_TIPOVENCIMIENTO" ("NCODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C00149836" ON "USER_APP" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "UK_65KUE06VU2G78MXPDFKE453E5" ON "USER_APP" ("USERNAME") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "UK_GSCVKQ9AKND7L2XNFYJCNIWLT" ON "SRET_TIPO_DOCUMENTO" ("S_NOMBRE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "UK_MK1XVWGET6PONRB1ELCQE09UV" ON "USER_APP" ("EMAIL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "UK_Q8IDRY0OEDE6X6G42CQ89NV68" ON "ROL_APP" ("NAME") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
--------------------------------------------------------
  ...
  ALTER TABLE "ROL_APP" ADD CONSTRAINT "UK_Q8IDRY0OEDE6X6G42CQ89NV68" UNIQUE ("NAME")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "ROL_APP" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "ROL_APP" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_APORTE
--------------------------------------------------------

  ALTER TABLE "SRET_APORTE" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_APORTE" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_APORTEDEDUCCION
--------------------------------------------------------

  ALTER TABLE "SRET_APORTEDEDUCCION" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_APORTEDEDUCCION" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_APORTEDESCUENTO
--------------------------------------------------------

  ALTER TABLE "SRET_APORTEDESCUENTO" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_APORTEDESCUENTO" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_APORTELIBERACION
--------------------------------------------------------

  ALTER TABLE "SRET_APORTELIBERACION" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_APORTELIBERACION" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_APORTEPORCENTAJE
--------------------------------------------------------

  ALTER TABLE "SRET_APORTEPORCENTAJE" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_APORTEPORCENTAJE" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_APORTETIPO
--------------------------------------------------------

  ALTER TABLE "SRET_APORTETIPO" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_APORTETIPO" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_ARCHIVO
--------------------------------------------------------

  ALTER TABLE "SRET_ARCHIVO" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_ARCHIVO" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_BANCO
--------------------------------------------------------

  ALTER TABLE "SRET_BANCO" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_BANCO" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_BASECALCULO
--------------------------------------------------------

  ALTER TABLE "SRET_BASECALCULO" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_BASECALCULO" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_BUENCONTRIBUYENTE
--------------------------------------------------------

  ALTER TABLE "SRET_BUENCONTRIBUYENTE" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_BUENCONTRIBUYENTE" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_CONCEPTO
--------------------------------------------------------

  ALTER TABLE "SRET_CONCEPTO" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_CONCEPTO" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_CONTRATO
--------------------------------------------------------

  ALTER TABLE "SRET_CONTRATO" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_CONTRATO" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_CONTRIBUYENTE
--------------------------------------------------------

  ALTER TABLE "SRET_CONTRIBUYENTE" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_CONTRIBUYENTE" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_CREDITO
--------------------------------------------------------

  ALTER TABLE "SRET_CREDITO" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_CREDITO" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_DEDUCCION
--------------------------------------------------------

  ALTER TABLE "SRET_DEDUCCION" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_DEDUCCION" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_DESCUENTO
--------------------------------------------------------

  ALTER TABLE "SRET_DESCUENTO" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_DESCUENTO" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_ESTADO
--------------------------------------------------------

  ALTER TABLE "SRET_ESTADO" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_ESTADO" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_LIBERACIONPAGO
--------------------------------------------------------

  ALTER TABLE "SRET_LIBERACIONPAGO" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_LIBERACIONPAGO" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_LIQUIDACION
--------------------------------------------------------

  ALTER TABLE "SRET_LIQUIDACION" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_LIQUIDACION" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_MODULO
--------------------------------------------------------

  ALTER TABLE "SRET_MODULO" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_MODULO" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_MONEDA
--------------------------------------------------------

  ALTER TABLE "SRET_MONEDA" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_MONEDA" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_PAGO
--------------------------------------------------------

  ALTER TABLE "SRET_PAGO" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_PAGO" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_PAGOSINAPORTE
--------------------------------------------------------

  ALTER TABLE "SRET_PAGOSINAPORTE" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_PAGOSINAPORTE" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_PARAMETRO
--------------------------------------------------------

  ALTER TABLE "SRET_PARAMETRO" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_PARAMETRO" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_PERFIL
--------------------------------------------------------

  ALTER TABLE "SRET_PERFIL" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_PERFIL" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_REPRESENTANTE
--------------------------------------------------------

  ALTER TABLE "SRET_REPRESENTANTE" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_REPRESENTANTE" MODIFY ("CONTRIBUYENTE_ID" NOT NULL ENABLE);
  ALTER TABLE "SRET_REPRESENTANTE" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_TIPOPERIODICIDAD
--------------------------------------------------------

  ALTER TABLE "SRET_TIPOPERIODICIDAD" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_TIPOPERIODICIDAD" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_TIPOPERIODICIDADDET
--------------------------------------------------------

  ALTER TABLE "SRET_TIPOPERIODICIDADDET" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_TIPOPERIODICIDADDET" MODIFY ("SMES_PERIODO" NOT NULL ENABLE);
  ALTER TABLE "SRET_TIPOPERIODICIDADDET" MODIFY ("SANIO_PERIODO" NOT NULL ENABLE);
  ALTER TABLE "SRET_TIPOPERIODICIDADDET" MODIFY ("DFECHAVENC" NOT NULL ENABLE);
  ALTER TABLE "SRET_TIPOPERIODICIDADDET" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_TIPORETRIBUCION
--------------------------------------------------------

  ALTER TABLE "SRET_TIPORETRIBUCION" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_TIPORETRIBUCION" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_TIPOVENCIMIENTO
--------------------------------------------------------

  ALTER TABLE "SRET_TIPOVENCIMIENTO" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_TIPOVENCIMIENTO" MODIFY ("SDESCRIPCION" NOT NULL ENABLE);
  ALTER TABLE "SRET_TIPOVENCIMIENTO" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SRET_TIPO_DOCUMENTO
--------------------------------------------------------

  ALTER TABLE "SRET_TIPO_DOCUMENTO" ADD CONSTRAINT "UK_GSCVKQ9AKND7L2XNFYJCNIWLT" UNIQUE ("S_NOMBRE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_TIPO_DOCUMENTO" ADD PRIMARY KEY ("NCODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "SRET_TIPO_DOCUMENTO" MODIFY ("NCODIGO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table USERS_ROLES
--------------------------------------------------------

  ALTER TABLE "USERS_ROLES" MODIFY ("ROLE_ID" NOT NULL ENABLE);
  ALTER TABLE "USERS_ROLES" MODIFY ("USER_ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "USER_APP" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
 
  
  
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "USER_APP" MODIFY ("ENABLED" NOT NULL ENABLE);
  ALTER TABLE "USER_APP" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Ref Constraints for Table SRET_APORTE
--------------------------------------------------------

  ALTER TABLE "SRET_APORTE" ADD CONSTRAINT "FKDE7NI1WFJNH7A15VFAU8HECSO" FOREIGN KEY ("NCODIGOAT")
	  REFERENCES "SRET_APORTETIPO" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_APORTE" ADD CONSTRAINT "FKF5VOQ67KPLJ90E8BW5UR120H1" FOREIGN KEY ("NCODIGOCN")
	  REFERENCES "SRET_CONTRIBUYENTE" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_APORTE" ADD CONSTRAINT "FKFM8398MNTJ3VODVREQ4UGV5CM" FOREIGN KEY ("S_TIPO_RETRIBUCION")
	  REFERENCES "SRET_TIPORETRIBUCION" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_APORTE" ADD CONSTRAINT "FKH7NSQL9Y08WXKH8EXCL2XL74M" FOREIGN KEY ("S_TIPO_PERIODICIDAD")
	  REFERENCES "SRET_TIPOPERIODICIDAD" ("NCODIGO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SRET_APORTEDEDUCCION
--------------------------------------------------------

  ALTER TABLE "SRET_APORTEDEDUCCION" ADD CONSTRAINT "FK3FOFR9FFMTPSECJ20TWX8UAK1" FOREIGN KEY ("ID_DEDUCCION")
	  REFERENCES "SRET_DEDUCCION" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_APORTEDEDUCCION" ADD CONSTRAINT "FK7W2SSDGYJO3M7OU23E5NMG6KN" FOREIGN KEY ("NCODIGO_APORTE")
	  REFERENCES "SRET_APORTE" ("NCODIGO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SRET_APORTEDESCUENTO
--------------------------------------------------------

  ALTER TABLE "SRET_APORTEDESCUENTO" ADD CONSTRAINT "FKAAOBQOKCRNJLIKTYBL3WVDN4I" FOREIGN KEY ("NCODIGO_APORTE")
	  REFERENCES "SRET_APORTE" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_APORTEDESCUENTO" ADD CONSTRAINT "FKCYUD62337QPELRQL17YU124QF" FOREIGN KEY ("ID_DESCUENTO")
	  REFERENCES "SRET_DESCUENTO" ("NCODIGO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SRET_APORTELIBERACION
--------------------------------------------------------

  ALTER TABLE "SRET_APORTELIBERACION" ADD CONSTRAINT "FK25SJVJQAA3L8BLF3K96WC6HMV" FOREIGN KEY ("ID_LIBERACION")
	  REFERENCES "SRET_LIBERACIONPAGO" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_APORTELIBERACION" ADD CONSTRAINT "FKOICKS2Q61J2G2QW1VOMLRPNNJ" FOREIGN KEY ("NCODIGO_APORTE")
	  REFERENCES "SRET_APORTE" ("NCODIGO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SRET_APORTEPORCENTAJE
--------------------------------------------------------

  ALTER TABLE "SRET_APORTEPORCENTAJE" ADD CONSTRAINT "FK36TWL6G4HO9II4P4MKR2L8W7Y" FOREIGN KEY ("TIPO_RETRIBUCION_NCODIGO")
	  REFERENCES "SRET_TIPORETRIBUCION" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_APORTEPORCENTAJE" ADD CONSTRAINT "FKH4TI59M5CX7PBHB5QT4OH293V" FOREIGN KEY ("CONTRIBUYENTE_NCODIGO")
	  REFERENCES "SRET_CONTRIBUYENTE" ("NCODIGO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SRET_BASECALCULO
--------------------------------------------------------

  ALTER TABLE "SRET_BASECALCULO" ADD CONSTRAINT "FKBY51JNEP8NY4TJH8A9HIJ4L0H" FOREIGN KEY ("NCODIGO_CONCEPTO")
	  REFERENCES "SRET_CONCEPTO" ("NCODIGO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SRET_CONCEPTO
--------------------------------------------------------

  ALTER TABLE "SRET_CONCEPTO" ADD CONSTRAINT "FKQO3VOK8JPIKQQ5MOIQDOKJUN6" FOREIGN KEY ("NCODIGO_MODULO")
	  REFERENCES "SRET_MODULO" ("NCODIGO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SRET_CONTRATO
--------------------------------------------------------

  ALTER TABLE "SRET_CONTRATO" ADD CONSTRAINT "FK7HYKW0OAELWGAUNEFJ53T8FPS" FOREIGN KEY ("NCODIGOCALENDARIO")
	  REFERENCES "SRET_TIPOPERIODICIDAD" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_CONTRATO" ADD CONSTRAINT "FK7UFIO79WWKG4I3MEPBN32C1PR" FOREIGN KEY ("NCODIGOCNT")
	  REFERENCES "SRET_CONTRIBUYENTE" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_CONTRATO" ADD CONSTRAINT "FKQOAAP3SQUB0DG4I7DHCPMW92W" FOREIGN KEY ("NCODIGOTPVENC")
	  REFERENCES "SRET_TIPOVENCIMIENTO" ("NCODIGO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SRET_CREDITO
--------------------------------------------------------

  ALTER TABLE "SRET_CREDITO" ADD CONSTRAINT "FK5FP57VS8FXBPKF0V01C78JFWX" FOREIGN KEY ("NCODIGO_ESTADO")
	  REFERENCES "SRET_ESTADO" ("NCODIGO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SRET_DEDUCCION
--------------------------------------------------------

  ALTER TABLE "SRET_DEDUCCION" ADD CONSTRAINT "FKHJD14VW4NRR9HWYLQN0Y00WIW" FOREIGN KEY ("MONEDA_NCODIGO")
	  REFERENCES "SRET_MONEDA" ("NCODIGO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SRET_DESCUENTO
--------------------------------------------------------

  ALTER TABLE "SRET_DESCUENTO" ADD CONSTRAINT "FK9J2QXWRT2NP8F47O19HO4GMSM" FOREIGN KEY ("MONEDA_NCODIGO")
	  REFERENCES "SRET_MONEDA" ("NCODIGO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SRET_LIBERACIONPAGO
--------------------------------------------------------

  ALTER TABLE "SRET_LIBERACIONPAGO" ADD CONSTRAINT "FK8UTU0U1O9KJGB24U68ORDWI2Y" FOREIGN KEY ("MONEDA_NCODIGO")
	  REFERENCES "SRET_MONEDA" ("NCODIGO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SRET_PAGO
--------------------------------------------------------

  ALTER TABLE "SRET_PAGO" ADD CONSTRAINT "FK3QXAL2YD2PTX1KDO35U5WPA0N" FOREIGN KEY ("NCODIGOMONEDA")
	  REFERENCES "SRET_MONEDA" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_PAGO" ADD CONSTRAINT "FKLBSYIARBFLYD29J62LKOFCDQR" FOREIGN KEY ("S_TIPO_PERIODICIDAD")
	  REFERENCES "SRET_TIPOPERIODICIDAD" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_PAGO" ADD CONSTRAINT "FKSRD4GB52RFGPJVGLY5SQ82MXS" FOREIGN KEY ("NCODIGOBANCO")
	  REFERENCES "SRET_BANCO" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_PAGO" ADD CONSTRAINT "FKT2V7CBPOC5FE3AMRY9DR4V105" FOREIGN KEY ("S_TIPO_RETRIBUCION")
	  REFERENCES "SRET_TIPORETRIBUCION" ("NCODIGO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SRET_PAGOSINAPORTE
--------------------------------------------------------

  ALTER TABLE "SRET_PAGOSINAPORTE" ADD CONSTRAINT "FK2FK5TH9RPSEPYTDTOBJ72FL1R" FOREIGN KEY ("S_TIPO_RETRIBUCION")
	  REFERENCES "SRET_TIPORETRIBUCION" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_PAGOSINAPORTE" ADD CONSTRAINT "FK9TM8AHOJ0ATKHAJPKB48MDKHC" FOREIGN KEY ("NCODIGOBANCO")
	  REFERENCES "SRET_BANCO" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_PAGOSINAPORTE" ADD CONSTRAINT "FKIOI59I3WBHQWOGVW2KO15WHTS" FOREIGN KEY ("NCODIGOMONEDA")
	  REFERENCES "SRET_MONEDA" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_PAGOSINAPORTE" ADD CONSTRAINT "FKJK05OO8YXPDP6CNPXDD9SYIKS" FOREIGN KEY ("S_TIPO_PERIODICIDAD")
	  REFERENCES "SRET_TIPOPERIODICIDAD" ("NCODIGO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SRET_REPRESENTANTE
--------------------------------------------------------

  ALTER TABLE "SRET_REPRESENTANTE" ADD CONSTRAINT "FK2BT2T2HPK1MDL1Q873VNPF7E7" FOREIGN KEY ("TIPODOCUMENTO_ID")
	  REFERENCES "SRET_TIPO_DOCUMENTO" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_REPRESENTANTE" ADD CONSTRAINT "FK61LU8V9B4WU1LI812NFRBHBU6" FOREIGN KEY ("CONTRIBUYENTE_ID")
	  REFERENCES "SRET_CONTRIBUYENTE" ("NCODIGO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SRET_TIPOPERIODICIDADDET
--------------------------------------------------------

  ALTER TABLE "SRET_TIPOPERIODICIDADDET" ADD CONSTRAINT "FK9U4DFW89PM9EULUC1FX6LP36J" FOREIGN KEY ("NCODIGO_CONCEPTO")
	  REFERENCES "SRET_CONCEPTO" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_TIPOPERIODICIDADDET" ADD CONSTRAINT "FKFJ9EMTBCB9J19UJV1FLN3RM0Q" FOREIGN KEY ("NCODIGOCONTRATO")
	  REFERENCES "SRET_CONTRATO" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_TIPOPERIODICIDADDET" ADD CONSTRAINT "FKMC905QUGYPD6R2JN1FFPO42NG" FOREIGN KEY ("N_TIPO_RETRIBUCION")
	  REFERENCES "SRET_TIPORETRIBUCION" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_TIPOPERIODICIDADDET" ADD CONSTRAINT "FKNXM6LSLUFLNYUK1P5SJMQYB1A" FOREIGN KEY ("N_TIPO_PERIODICIDAD")
	  REFERENCES "SRET_TIPOPERIODICIDAD" ("NCODIGO") ENABLE;
  ALTER TABLE "SRET_TIPOPERIODICIDADDET" ADD CONSTRAINT "FKPLR4AA5FRFO1KTPG557Q507F" FOREIGN KEY ("NCODIGOTPVENC")
	  REFERENCES "SRET_TIPOVENCIMIENTO" ("NCODIGO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table USERS_ROLES
--------------------------------------------------------

  ALTER TABLE "USERS_ROLES" ADD CONSTRAINT "FK50GPSRE6OXWWQF394F8WOV1YF" FOREIGN KEY ("USER_ID")
	  REFERENCES "USER_APP" ("ID") ENABLE;
  ALTER TABLE "USERS_ROLES" ADD CONSTRAINT "FKRK51QVDQU4F4C0WE5N84X38A6" FOREIGN KEY ("ROLE_ID")
	  REFERENCES "ROL_APP" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table USER_APP
--------------------------------------------------------

  ALTER TABLE "USER_APP" ADD CONSTRAINT "FK792QGGPV012CK9U3VXJJUTS0V" FOREIGN KEY ("NCODIGOCNT")
	  REFERENCES "SRET_CONTRIBUYENTE" ("NCODIGO") ENABLE;
  ALTER TABLE "USER_APP" ADD CONSTRAINT "FK87HAMEXPS115BQ52GFEXHT3SJ" FOREIGN KEY ("NCODIGO_PERFIL")
	  REFERENCES "SRET_PERFIL" ("NCODIGO") ENABLE;
--------------------------------------------------------
